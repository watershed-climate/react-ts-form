...
export type SchemaShape<SchemaType extends z.ZodObject> = SchemaType["shape"];
...
>(
  ...
  return createTsFormAndFragment<Mapping, PropsMapType, FormType>(componentMap, options)[0];
}
...
function useSubmitter<SchemaType extends z.ZodObject>({
  ...
  async function submit(data: z.infer<SchemaType>) {
    const e = await (resolver(removeUndefined(data) as any, {}, {} as any) as Promise<ResolverResult<z.infer<SchemaType>, any>>);
